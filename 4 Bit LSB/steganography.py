...
class Steganography(object):
    ...
    def unmerge(img):
        ...
        # Load the pixel map to access the data in the pixel
        pixel_map = img.load()

        # Create the new image and load the pixel map to access the data
        new_image = Image.new(img.mode, img.size)
        pixels_new = new_image.load()

        # Tuple(Row) used to store the image original size
